      ...
      <section className="container mx-auto px-4 py-5">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need for personalized nutrition and daily meal
            delivery
          </p>
        </div>
        ...
        <Card className="max-w-md mx-auto border-2 border-primary transition-all hover:shadow-xl hover:-translate-y-1">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Complete nutrition & delivery service
            </CardDescription>
            <div className="mt-4">
        ...
        <div className="max-w-2xl mx-auto mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Complete health data submission and make your first payment to
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Your dietitian creates your personalized menu (24-48h). You
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Enjoy 30 days of fresh meals. Auto-renewal monthly unless you
                  cancel.
                </p>
              </CardContent>
            </Card>
        ...
        <Card className="max-w-2xl mx-auto mt-12 bg-muted border-0">
          <CardHeader>
            ...
            <CardDescription>
              Contact our support team at support@nutriflow.com or check our FAQ
