...
export default function Register() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-primary-lighter to-white overflow-x-hidden flex items-center justify-center px-6 lg:px-10">
      <div
        className="w-full max-w-5xl flex gap-10 items-strectch"
          ...
          <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent flex flex-col justify-end p-8 text-white">
              ...
              <p className="text-sm opacity-85 leading-relaxed">
                Get personalized nutrition guidance from certified dietitians
                and enjoy daily meal delivery.
              </p>
            </div>
          </div>
        </motion.div>
            ...
            <div className="w-full max-w-[520px]">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Join NutriFlow and start your nutrition journey
                  </CardDescription>
                </CardHeader>
                <CardContent>
